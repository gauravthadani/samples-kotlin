...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in temporal/api/operatorservice/v1/service_pb2_grpc.py depends on'
...
def add_OperatorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('temporal.api.operatorservice.v1.OperatorService', rpc_method_handlers)
...
class OperatorService(object):
    ...
    @staticmethod
    def AddSearchAttributes(request,
            target,
            options=(),
    ...
    @staticmethod
    def RemoveSearchAttributes(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ListSearchAttributes(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def RemoveRemoteCluster(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def CreateNexusEndpoint(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def UpdateNexusEndpoint(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def DeleteNexusEndpoint(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ListNexusEndpoints(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
