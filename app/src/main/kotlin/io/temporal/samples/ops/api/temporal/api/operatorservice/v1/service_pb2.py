...
from temporal.api.operatorservice.v1 import request_response_pb2 as temporal_dot_api_dot_operatorservice_dot_v1_dot_request__response__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'temporal.api.operatorservice.v1.service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_OPERATORSERVICE'].methods_by_name['ListSearchAttributes']._loaded_options = None
  _globals['_OPERATORSERVICE'].methods_by_name['ListSearchAttributes']._serialized_options = b'\202\323\344\223\002g\0221/cluster/namespaces/{namespace}/search-attributesZ2\0220/api/v1/namespaces/{namespace}/search-attributes'
  _globals['_OPERATORSERVICE'].methods_by_name['GetNexusEndpoint']._loaded_options = None
  _globals['_OPERATORSERVICE'].methods_by_name['GetNexusEndpoint']._serialized_options = b'\202\323\344\223\002?\022\035/cluster/nexus/endpoints/{id}Z\036\022\034/api/v1/nexus/endpoints/{id}'
  _globals['_OPERATORSERVICE'].methods_by_name['CreateNexusEndpoint']._loaded_options = None
  _globals['_OPERATORSERVICE'].methods_by_name['CreateNexusEndpoint']._serialized_options = b'\202\323\344\223\002;\"\030/cluster/nexus/endpoints:\001*Z\034\"\027/api/v1/nexus/endpoints:\001*'
  _globals['_OPERATORSERVICE'].methods_by_name['UpdateNexusEndpoint']._loaded_options = None
  _globals['_OPERATORSERVICE'].methods_by_name['UpdateNexusEndpoint']._serialized_options = b'\202\323\344\223\002S\"$/cluster/nexus/endpoints/{id}/update:\001*Z(\"#/api/v1/nexus/endpoints/{id}/update:\001*'
  _globals['_OPERATORSERVICE'].methods_by_name['DeleteNexusEndpoint']._loaded_options = None
  _globals['_OPERATORSERVICE'].methods_by_name['DeleteNexusEndpoint']._serialized_options = b'\202\323\344\223\002?*\035/cluster/nexus/endpoints/{id}Z\036*\034/api/v1/nexus/endpoints/{id}'
  _globals['_OPERATORSERVICE'].methods_by_name['ListNexusEndpoints']._loaded_options = None
  _globals['_OPERATORSERVICE'].methods_by_name['ListNexusEndpoints']._serialized_options = b'\202\323\344\223\0025\022\030/cluster/nexus/endpointsZ\031\022\027/api/v1/nexus/endpoints'
  _globals['_OPERATORSERVICE']._serialized_start=169
  _globals['_OPERATORSERVICE']._serialized_end=2415
