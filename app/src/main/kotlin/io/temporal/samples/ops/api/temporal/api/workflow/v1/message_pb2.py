...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'temporal.api.workflow.v1.message_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_WORKFLOWEXECUTIONINFO'].fields_by_name['most_recent_worker_version_stamp']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONINFO'].fields_by_name['most_recent_worker_version_stamp']._serialized_options = b'\030\001'
  _globals['_WORKFLOWEXECUTIONINFO'].fields_by_name['assigned_build_id']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONINFO'].fields_by_name['assigned_build_id']._serialized_options = b'\030\001'
  _globals['_WORKFLOWEXECUTIONINFO'].fields_by_name['inherited_build_id']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONINFO'].fields_by_name['inherited_build_id']._serialized_options = b'\030\001'
  _globals['_WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY']._serialized_options = b'8\001'
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO'].fields_by_name['deployment']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO'].fields_by_name['deployment']._serialized_options = b'\030\001'
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO'].fields_by_name['version']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO'].fields_by_name['version']._serialized_options = b'\030\001'
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO'].fields_by_name['deployment_transition']._loaded_options = None
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO'].fields_by_name['deployment_transition']._serialized_options = b'\030\001'
  _globals['_DEPLOYMENTVERSIONTRANSITION'].fields_by_name['version']._loaded_options = None
  _globals['_DEPLOYMENTVERSIONTRANSITION'].fields_by_name['version']._serialized_options = b'\030\001'
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['use_workflow_build_id']._loaded_options = None
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['use_workflow_build_id']._serialized_options = b'\030\001'
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_independently_assigned_build_id']._loaded_options = None
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_independently_assigned_build_id']._serialized_options = b'\030\001'
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_worker_version_stamp']._loaded_options = None
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_worker_version_stamp']._serialized_options = b'\030\001'
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_deployment']._loaded_options = None
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_deployment']._serialized_options = b'\030\001'
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_worker_deployment_version']._loaded_options = None
  _globals['_PENDINGACTIVITYINFO'].fields_by_name['last_worker_deployment_version']._serialized_options = b'\030\001'
  _globals['_RESETPOINTINFO'].fields_by_name['binary_checksum']._loaded_options = None
  _globals['_RESETPOINTINFO'].fields_by_name['binary_checksum']._serialized_options = b'\030\001'
  _globals['_PENDINGNEXUSOPERATIONINFO'].fields_by_name['operation_id']._loaded_options = None
  _globals['_PENDINGNEXUSOPERATIONINFO'].fields_by_name['operation_id']._serialized_options = b'\030\001'
  _globals['_VERSIONINGOVERRIDE'].fields_by_name['behavior']._loaded_options = None
  _globals['_VERSIONINGOVERRIDE'].fields_by_name['behavior']._serialized_options = b'\030\001'
  _globals['_VERSIONINGOVERRIDE'].fields_by_name['deployment']._loaded_options = None
  _globals['_VERSIONINGOVERRIDE'].fields_by_name['deployment']._serialized_options = b'\030\001'
  _globals['_VERSIONINGOVERRIDE'].fields_by_name['pinned_version']._loaded_options = None
  _globals['_VERSIONINGOVERRIDE'].fields_by_name['pinned_version']._serialized_options = b'\030\001'
  _globals['_WORKFLOWEXECUTIONINFO']._serialized_start=552
  _globals['_WORKFLOWEXECUTIONINFO']._serialized_end=1747
  _globals['_WORKFLOWEXECUTIONEXTENDEDINFO']._serialized_start=1750
  _globals['_WORKFLOWEXECUTIONEXTENDEDINFO']._serialized_end=2258
  _globals['_WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY']._serialized_start=2164
  _globals['_WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY']._serialized_end=2258
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO']._serialized_start=2261
  _globals['_WORKFLOWEXECUTIONVERSIONINGINFO']._serialized_end=2762
  _globals['_DEPLOYMENTTRANSITION']._serialized_start=2764
  _globals['_DEPLOYMENTTRANSITION']._serialized_end=2846
  _globals['_DEPLOYMENTVERSIONTRANSITION']._serialized_start=2849
  _globals['_DEPLOYMENTVERSIONTRANSITION']._serialized_end=2980
  _globals['_WORKFLOWEXECUTIONCONFIG']._serialized_start=2983
  _globals['_WORKFLOWEXECUTIONCONFIG']._serialized_end=3310
  _globals['_PENDINGACTIVITYINFO']._serialized_start=3313
  _globals['_PENDINGACTIVITYINFO']._serialized_end=5038
  _globals['_PENDINGACTIVITYINFO_PAUSEINFO']._serialized_start=4682
  _globals['_PENDINGACTIVITYINFO_PAUSEINFO']._serialized_end=5017
  _globals['_PENDINGACTIVITYINFO_PAUSEINFO_MANUAL']._serialized_start=4903
  _globals['_PENDINGACTIVITYINFO_PAUSEINFO_MANUAL']._serialized_end=4945
  _globals['_PENDINGACTIVITYINFO_PAUSEINFO_RULE']._serialized_start=4947
  _globals['_PENDINGACTIVITYINFO_PAUSEINFO_RULE']._serialized_end=5004
  _globals['_PENDINGCHILDEXECUTIONINFO']._serialized_start=5041
  _globals['_PENDINGCHILDEXECUTIONINFO']._serialized_end=5226
  _globals['_PENDINGWORKFLOWTASKINFO']._serialized_start=5229
  _globals['_PENDINGWORKFLOWTASKINFO']._serialized_end=5498
  _globals['_RESETPOINTS']._serialized_start=5500
  _globals['_RESETPOINTS']._serialized_end=5571
  _globals['_RESETPOINTINFO']._serialized_start=5574
  _globals['_RESETPOINTINFO']._serialized_end=5813
  _globals['_NEWWORKFLOWEXECUTIONINFO']._serialized_start=5816
  _globals['_NEWWORKFLOWEXECUTIONINFO']._serialized_end=6717
  _globals['_CALLBACKINFO']._serialized_start=6720
  _globals['_CALLBACKINFO']._serialized_end=7314
  _globals['_CALLBACKINFO_WORKFLOWCLOSED']._serialized_start=7194
  _globals['_CALLBACKINFO_WORKFLOWCLOSED']._serialized_end=7210
  _globals['_CALLBACKINFO_TRIGGER']._serialized_start=7212
  _globals['_CALLBACKINFO_TRIGGER']._serialized_end=7314
  _globals['_PENDINGNEXUSOPERATIONINFO']._serialized_start=7317
  _globals['_PENDINGNEXUSOPERATIONINFO']._serialized_end=7975
  _globals['_NEXUSOPERATIONCANCELLATIONINFO']._serialized_start=7978
  _globals['_NEXUSOPERATIONCANCELLATIONINFO']._serialized_end=8366
  _globals['_WORKFLOWEXECUTIONOPTIONS']._serialized_start=8368
  _globals['_WORKFLOWEXECUTIONOPTIONS']._serialized_end=8469
  _globals['_VERSIONINGOVERRIDE']._serialized_start=8472
  _globals['_VERSIONINGOVERRIDE']._serialized_end=9045
  _globals['_VERSIONINGOVERRIDE_PINNEDOVERRIDE']._serialized_start=8755
  _globals['_VERSIONINGOVERRIDE_PINNEDOVERRIDE']._serialized_end=8928
  _globals['_VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR']._serialized_start=8930
  _globals['_VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR']._serialized_end=9033
  _globals['_ONCONFLICTOPTIONS']._serialized_start=9047
  _globals['_ONCONFLICTOPTIONS']._serialized_end=9152
  _globals['_REQUESTIDINFO']._serialized_start=9154
  _globals['_REQUESTIDINFO']._serialized_end=9259
  _globals['_POSTRESETOPERATION']._serialized_start=9262
  _globals['_POSTRESETOPERATION']._serialized_end=9829
  _globals['_POSTRESETOPERATION_SIGNALWORKFLOW']._serialized_start=9476
  _globals['_POSTRESETOPERATION_SIGNALWORKFLOW']._serialized_end=9655
  _globals['_POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS']._serialized_start=9658
  _globals['_POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS']._serialized_end=9818
